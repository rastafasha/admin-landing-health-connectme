...
export class ProfileComponent implements OnInit {
      ...
      this.profileService.getProfile(+id).subscribe(
        res => {
          this.perfilForm.patchValue({
            ...
            emailBinance: res.emailBinance,
            userIdBinance: res.userIdBinance,
  ...
  get shortdescription() { return this.perfilForm.get('shortdescription'); }
  get emailPaypal() { return this.perfilForm.get('emailPaypal'); }
  get nombrePaypal() { return this.perfilForm.get('nombrePaypal'); }
  get emailBinance() { return this.perfilForm.get('emailBinance'); }
  get userIdBinance() { return this.perfilForm.get('userIdBinance'); }
  ...
  const formData = new FormData();
    ...
    formData.append('nombrePaypal', this.perfilForm.get('nombrePaypal')?.value);
    formData.append('emailBinance', this.perfilForm.get('emailBinance')?.value);
    formData.append('userIdBinance', this.perfilForm.get('userIdBinance')?.value);
