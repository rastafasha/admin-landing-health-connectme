...
const childRoutes: Routes = [
    ...
    { path: 'workshops',  component: WorkshopsComponent, data:{title:'Workshops'} },
    { path: 'workshops1',  component: Workshop1Component, data:{title:'Workshop1'} },
    { path: 'workshop/detail/:id',  component: WorkshopDetailComponent, data:{title:'Workshop1'} },
